...
/*
  Performs a dfs on the matrix with the settings previously set on solver_init to s.
  This dfs has a prunning function, a testing function and an adding function depending on the game mode
*/
